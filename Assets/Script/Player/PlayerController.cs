   ...
   // Update is called once per frame
    ...
    private void OnTriggerEnter(Collider hit)
    {
        ...
        if (hit.gameObject.tag == "PulsantePorta")
        {
            ...
            {
                audioController.PlayMusic("PortaAperta");
            ...
            {
                audioController.PlayMusic("PortaChiusa");
            }
        }
        ...
        if (hit.gameObject.tag == "TriggerNaveSorvolo")
        {
            ...
            audioController.PlayMusic("SpaceshipFlyby");
        ...
        if (hit.gameObject.tag == "EndLevel")
        {
            if (weaponEquipped == true)
            {
                ...
                audioController.PlayMusic("Teletrasporto");
                audioController.StopMusic("Rain_Terra");
